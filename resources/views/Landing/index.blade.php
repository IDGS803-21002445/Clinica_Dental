...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap -->
        <link
            href="{{ asset('landing/css/bootstrap.min.css') }}"
            rel="stylesheet">
        ...
        <link rel="shortcut icon" href="{{ asset('landing/img/download (35).png') }}"
            type="image/x-icon">
    ...
    <body>
            ...
            <nav class="navbar main-nav fixed-top py-3 navbar-expand-lg">
                <div
                    ...
                    <ul class="nav d-none d-lg-flex">
                        ...
                        <li class="nav-item"><a class="nav-link"
                                href="{{ route('solutions') }}">Solutions</a></li>
                    </ul>
            ...
            <div class="offcanvas offcanvas-end" id="mobileMenu"
                ...
                <div class="offcanvas-body">
                    ...
                    <ul class="navbar-nav gap-2">
                        ...
                        <li><a class="nav-link" href="{{ route('whyus') }}">Why
                                Us</a></li>
                        <li><a class="nav-link"
                                href="{{ route('services') }}">Services</a></li>
            ...
            <div class="row align-items-center testimonial-box">
                ...
                <div class="col-md-6 testimonial-content">
                    ...
                    <div class="review-person">
                        <img src="{{ asset('landing/img/pro.jpg') }}" class="review-avatar">
                        <div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="blog-card d-flex">
                        ...
                        <img
                            src="{{ asset('landing/img/blog2.jpg') }}"
                            class="blog-img">
        ...
        <footer class="footer-section py-5 mt-5">
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <!-- Newsletter -->
                    <div class="col-lg-4">
                        <h6 class="fw-bold">Subscribe to our
                            Newsletter</h6>
        ...
        <script
            src="{{ asset('landing/js/bootstrap.bundle.min.js') }}"></script>
